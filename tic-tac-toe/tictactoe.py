...
def gameEnded(board, le1, le2):
    if isBoardFull(board) or isWinner(board, le1) or isWinner(board, le2):
        return True
    return False
...
def getComputerMoveMM(board, computerLetter, playerLetter, steps):
    from minimax import minimax
    (v, m) = minimax(board, steps, steps, True, computerLetter, playerLetter)
    #print('chose move {0} with value {1}'.format(m, v))
    return m 
