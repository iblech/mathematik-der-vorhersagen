...
<\body>
  ...
  </doc-subtitle>||||<doc-author|<\author-data|<author-name|Philipp Düren &
  Ingo Blechschmidt>>
    \;
  ...
  <abstract-data|<\abstract>
    In diesem Skript wirst du (fast) alles lernen, was du für unseren Kurs an
    Wissen über Differentialrechnung brauchst. Die Differentialrechnung ist
    ein groÿartiges Gebiet der Mathematik, das sich mit der Summe von
    unendlich vielen unendlich kleinen Zahlen beschäftigt. Klingt etwas
    esoterisch, ist aber unglaublich nützlich!
  ...
  In der angewandten Mathematik erweist es sich oft nützlich, Funktionen
  zuzulassen, die Definitions- und Wertemengen haben, die eine höhere
  ...
  Längengrade beschrieben wird, also zwei Koordinatenkomponenten hat) die
  Höhe zuordnet, die der Berg an diesem Punkt hat.
  ...
  entspricht der Höhe der Oberfläche senkrecht über diesem Punkt.>

  Ein weiteres Beispiel ist die Geschwindigkeit von Wasserwellen auf einer
  Wasseroberfläche: Wir können in jedem Punkt auf der Wasseroberfläche einen
  Pfeil einzeichnen, der in die Richtung zeigt, in den sich ein Molekül
  Wasser in der nächsten Sekunde bewegen wird.
  ...
  den wir graphisch an <math|w> als Vektor anhängen. Dies machen wir
  natürlich nicht in jedem Punkt (sonst wäre alles voller Linien). Die Länge
  des Vektors entspricht der Stärke der Strömung in diesem Punkt.>

  Ein letztes Beispiel: Wenn wir ein Pendel anstoÿen und filmen, erhalten wir
  ...
  können wir eine dazu senkrecht stehende Schnittebene einsetzen. Auf dieser
  ...
  ist ein Beispiel für eine Funktion <math|f:\<bbb-R\>\<supset\><around*|[|t<rsub|1>,t<rsub|2>|]>\<rightarrow\>\<bbb-R\><rsup|2>>,
  also von einer Dimension in zwei Dimensionen.>

  Für Funktionen <math|f:\<bbb-R\>\<supset\>M\<rightarrow\>\<bbb-R\><rsup|n>>,
  also speziell Funktionen, die von einer Dimension in beliebige Dimensionen
  gehen, wählt man oft auch eine alternative Wahl der Visualisierung: Man
  interpretiert die Eingabekoordinate (also die Variablen in der
  Definitionsmenge) als Zeitkoordinate und trägt den \Raktuellen Punkt zur
  Zeit <math|t>`` in ein Koordinatensystem <math|\<bbb-R\><rsup|n>> ein: Das
  dritte Beispiel sähe dann so aus:
  ...
  zusammenstaucht. Auÿerdem sind die Funktionswerte für drei Zeitpunkte
  eingetragen: Den Punkten pink, rot und grün entsprechen die Zeitpunkte
  ...
  <\exercise>
    ...
    wenn <math|v> den Geschwindigkeitsvektor der Luft in der Atmosphäre
    beschreibt? Nimm an, dass wir nur einen kleinen Abschnitt der Atmosphäre
    betrachten (also ein würfelförmiges \RStück Luft``, das über der
    Oberfläche schwebt). Versuche, dir eine Visualisierung dieser Funktion zu
    überlegen (mittelschwierig), zu zeichnen (mittelschwierig) oder mit einem
  ...
  <\question*>
    Was ist die aktuelle Änderungsrate einer Funktion in einem Punkt?
  </question*>

  Zuerst müssen wir verstehen, was diese Frage überhaupt bedeuten soll.
  Betrachten wir dazu die Höhenfunktion einer Silvesterrakete nach dem
  Anzünden der Zündschnur:

  <big-figure|<image|positionRocket.png|799px|599px||>|Die Höhe einer (nicht
  explodierenden) Silvesterrakete nach dem Anzünden als eine Funktion von der
  ...
  Rakete 0. In diesem Moment hängt die Rakete regungslos in der Luft, um
  gleich darauf Richtung Boden zu fallen (negative Geschwindigkeit).>

  Wir können folgende relevanten Zeitpunkte und Phasen ausmachen:
  ...
  erschöpft (<math|\<approx\>8 s>)|<point|-2.0|-1.38163868019324>>|<with|line-width|5ln|<line|<point|-0.641933|-0.646167>|<point|-0.633372762879084|-1.0>>>|<with|line-width|5ln|<line|<point|4.28729|-0.610448>|<point|4.28917087802009|-1.0>>>|<text-at|Ende
  des Steigfluges (<math|\<approx\>17 s>)|<point|2.64421550469639|-1.37840653525599>>|<text-at|Aufwärtsbewegung|<point|-6.0|0.216364854198757>>|<text-at|bei
  gleichzeitiger Beschleunigung|<point|-7.0|-0.217871581283796>>|<text-at|Aufwärtsbewegung|<point|0.510128627817342|0.160851303082418>>|<text-at|bei
  gleichzeitiger Abbremsung|<point|-0.445478899325308|-0.235398200820214>>|<text-at|Abwärtsbewegung|<point|3.41217422939542|1.21122172245006>>|<text-at|bei
  gleichzeitiger Abwärtsbeschleunigung|<point|1.19759558142611|0.746874586585527>>|<text-at|(Erdanziehung)|<point|5|0.260589>>|<with|line-width|5ln|<line|<point|-0.463338|1.46125>|<point|-0.481685460907156|1.0>|<point|1.08002050535785|0.5607223177669>|<point|4.88244146051065|0.348756449265776>|<point|5.18813702703437|0.0>|<point|7.25896468275713|0.0>>>>>|Der
  Lebenslauf unserer Rakete (viel später, bei etwa <math|30 s>, wird die
  ...
  <big-table|<tabular|<tformat|<cwith|1|-1|1|-1|cell-hyphen|n>|<table|<row|<cell|>|<cell|Höhendiagramm>|<cell|Geschwindigkeitsdiagramm>>|<row|<cell|Start>|<cell|<math|0>>|<cell|<math|0>>>|<row|<cell|Phase
  1>|<cell|steigend, linksgekrümmt>|<cell|positiv,
  steigend>>|<row|<cell|Treibstoff verbraucht>|<cell|Krümmungswechsel>|<cell|Wechsel
  zwischen steigend und fallend>>|<row|<cell|Phase 2>|<cell|steigend,
  rechtsgekrümmt>|<cell|positiv, fallend>>|<row|<cell|Ende des
  Steigfluges>|<cell|waagerechte Richtung>|<cell|<math|0>>>|<row|<cell|Phase
  3>|<cell|fallend, rechtsgekrümmt>|<cell|negativ, fallend>>>>>|Eigenschaften
  der Graphen>

  Wir erkennen folgende Zusammenhänge:

  <\note*>
    \;

    <\itemize>
      <item>Immer, wenn das Höhendiagramm ansteigt, ist das
      Geschwindigkeitsdiagramm positiv.

      <item>Immer, wenn das Höhendiagramm abfällt, ist das
      Geschwindigkeitsdiagramm negativ.

      <item>Immer, wenn das Höhendiagramm linksgekrümmt ist, ist das
      Geschwindigkeitsdiagramm steigend.

      <item>Immer, wenn das Höhendiagramm rechtsgekrümmt ist, ist das
      Geschwindigkeitsdiagramm fallend.

      <item>Punkte, an denen das Höhendiagramm flach ist (<math|0 s> und
      <math|17 s>), sind Nullstellen des Geschwindigkeitsdiagramms.
    </itemize>
  </note*>

  Wir wollen nun verstehen, wie man diese Zusammenhänge mathematisch fassen
  kann.
  ...
  <math|t<rsub|1>> und <math|t<rsub|2>> wählt und die Strecke <math|s> misst,
  die das Objekt in dieser Zeit <math|t=t<rsub|2>-t<rsub|1>> zurücklegt. Die
  Durchschnittsgeschwindigkeit während dieser Bewegung (also im Zeitraum
  ...
  haben zwei Zeitpunkte <math|t<rsub|1>> und <math|t<rsub|2>> gewählt und
...
<\auxiliary>
  <\collection>
    <\associate|figure>
      ...
      Wert der Funktion in diesem Punkt entspricht der Höhe der Oberfläche
      senkrecht über diesem Punkt.|<pageref|auto-3>>
      ...
      wir graphisch an <with|mode|<quote|math>|w> als Vektor anhängen. Dies
      machen wir natürlich nicht in jedem Punkt (sonst wäre alles voller
      Linien). Die Länge des Vektors entspricht der Stärke der Strömung in
      ...
      (die rote Linie ist die Zeitachse) können wir eine dazu senkrecht
      ...
      liegt, genau die Bahn eines Pendels. Dies ist ein Beispiel für eine
      ...
      Kurve in Abbildung <reference|im:pend> zusammenstaucht. Auÿerdem sind
      die Funktionswerte für drei Zeitpunkte eingetragen: Den Punkten pink,
      rot und grün entsprechen die Zeitpunkte <with|mode|<quote|math>|1.9>,
      ...
      <tuple|normal|Die Höhe einer (nicht explodierenden) Silvesterrakete
      nach dem Anzünden als eine Funktion von der Zeit in Sekunden:
      ...
      Geschwindigkeit der Rakete 0. In diesem Moment hängt die Rakete
    ...
    <\associate|toc>
      ...
      Differenzen und Zuwächse> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
